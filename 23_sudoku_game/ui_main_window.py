...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridWidget.setGeometry(QRect(10, 30, 781, 541))
        self.gridWidget.setStyleSheet(u"border: 2px solid black;\n"
"  border-radius: 5px;")
        ...
        self.dark_mode_toggle_btn.setStyleSheet(u"border: 2px solid black;\n"
"  border-radius: 5px;")
        self.exit_btn = QPushButton(self.centralwidget)
        self.exit_btn.setObjectName(u"exit_btn")
        self.exit_btn.setGeometry(QRect(720, 0, 31, 31))
        self.exit_btn.setStyleSheet(u"border: 2px solid black;\n"
"  border-radius: 5px;")
